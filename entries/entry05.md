...
In terms of EDP (Education Design Process) I am currently on stage 6 and 7  which is now testing the game and seeing if we need to make minor updates or fix any bugs. The MVP is now done and we have something we can showcase. We need to procede with stage 7 because if we can go above and beyond that would be great for us to show everyone how cool our game looks. In terms of skills I would say I need to learn communication and debugging. Over this semester Ive been encountered in a situation where I dont know how to solve a line of code and usually in that scenario I would ask my friend safe for help. Ive noticed that as I communicate with him and explain to him why I dont know why the code is working I realize my problem mid way of the sentence. I think communicating is very important and can lead to many discoveries based on my expieriences. For debugging it is important to read your erros because a lot of times this year my code doesnt work due to a missing syntax.
